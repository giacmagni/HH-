...
int main(int argc, char** argv){
    ...
    double n_eta, n_pt;
    double vbs1_eta, vbs1_pt, vbs1_phi, vbs2_eta, vbs2_pt;
	double b1_eta, b1_pt, b1_phi, b2_eta, b2_pt;
    double mww, mvbs, mbb;
	double ww_pt, vbs_pt, bb_pt;
	double vbs_Et, bb_Et;
	double Ht, Htnu, Ptm;
    
    TH1F *q1 = new TH1F("q1", "PGID of vbs1", 80, -10, 10);
	TH1F *q2 = new TH1F("q2", "PGID of vbs2", 80, -10, 10);   
    TH1F* l1 = new TH1F("l1", "PGID of lepton", 160, -20, 20);
...
//                         << endl;
			...
			// // Events with a DOUBLE JET or NO JET are not saved.   
